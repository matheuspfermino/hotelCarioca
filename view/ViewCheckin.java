...
public class ViewCheckin extends javax.swing.JFrame {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
       if (jTCheckin.getSelectedRow() != -1) {
        try {
            ...
            Checkin checkinAtualizado = new Checkin();
            ...
            checkinBD checkinBD = new checkinBD();

            checkinBD.updateCheckin(checkinAtualizado);
    ...
    private void jTCheckinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTCheckinMouseClicked
            CheckinTableModel tblModel = (CheckinTableModel)jTCheckin.getModel();
